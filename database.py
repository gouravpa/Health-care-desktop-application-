...
c.execute("""create table appointment
            (
             ...
             FOREIGN KEY(PATIENT_ID) references PATIENT(PATIENT_ID),
             FOREIGN KEY(DoctorID) references employee(DoctorID));""")
...
c.execute("""create table bill
            (
             Bid int(20) primary key,Pid int(20) not null,discharge_dt varchar(50) not null,treatment varchar(50) not null,treatment_cost varchar(50) not null,medicine varchar(50) not null,medicine_Quantity varchar(50) not null,medicine_price varchar(50) not null)""")
print("APPOINTMENT TABLE CREATED SUCCESSFULLY")
conn.commit()
conn.close()
